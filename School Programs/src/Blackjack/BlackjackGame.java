...
public class BlackjackGame implements Runnable {
    ...
    private void save() {
        ...
        if (debugMode) System.out.println("Saving Complete");
    }
    ...
    private void shuffle() {
        for (int x = 1; x <= shuffleCount; x++) {
            for (int i = 1; i <= cardNum; i++) {
                ...
                if (debugMode) System.out.println("Shuffle count:" + x + " \tSwitch:" + i + " \tSwitched card " + arrayIndex + " \tWith card " + i);
            }
        }
    }
    ...
    private void setDisplayNames() {
        for (int i = 1; i <= cardNum; i++) {
            ...
            if (debugMode) System.out.println(i + "\t\t" + cardValue[i] + "\t\t" + cardSuit[i] + "\t\t\t" + cardDisplayName[i]);
        }
    }
    ...
    private int mainMenu() {
        ...
        if (debugMode) System.out.println("Now reading from file...");
        ...
        try {
            ...
            if (debugMode) System.out.println("A prexsiting setting file doesn't exist, Creating a new one...");
            /*
        ...
        do {
            ...
            try {
                ...
                if (selection > 2 || selection < 1) REDO = true;
            }
            catch (Exception e) {
                if (debugMode) e.printStackTrace();
    ...
    private void hit() {
        ...
        if (playerTotal <= 21) System.out.println("\nYour total is: " + playerTotal);
    }
    ...
    private void dealer() {
        ...
        if (dealerTotal <= 21) System.out.println("\nThe dealer stays");
    }
